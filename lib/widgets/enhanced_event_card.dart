...
class _EnhancedEventCardState extends State<EnhancedEventCard> 
  ...
  Future<void> _handleReservation() async {
    ...
    try {
      ...
      // Error handling can be done by parent widget
  ...
  Future<void> _openMap() async {
    ...
    try {
      final success = await MapsLauncher.launchQuery(widget.event.address);
      if (!success && mounted) {
        _showMapError();
      }
    } catch (e) {
    ...
    return Positioned(
      ...
      child: Column(
        ...
        children: [
          ...
          _buildEventDetails(),
          if (widget.onReserve != null && widget.currentUser != null) ...[
            const SizedBox(height: 12),
  ...
  Widget _buildReservationButton() {
    ...
    return SizedBox(
      ...
      child: CupertinoButton(
        ...
        onPressed: isDisabled ? null : _handleReservation,
        child: _isReserving
            ? Row(
                mainAxisSize: MainAxisSize.min,
                children: [
